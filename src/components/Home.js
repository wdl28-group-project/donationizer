...
class Home extends React.Component {
  ...
  render() {
    ...
    let mappedDonation = this.props.donations.map((el,i)=>{
        return(
            <div key={el.donation_title+i} className="donation-card"
    ...
    let filteredDonation = this.props.donations.filter((el)=>{
      ...
      <div className="parent-container">
        ...
        <div className="donation-container">
          ...
          <div className="search">
            <MdSearch size='25px'/>
            <input placeholder="search donations" id="input" name="search" onChange={this.handleChange}/>
          </div>
          </div>
